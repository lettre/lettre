...
/// Set min TLS Protocol
pub const DEFAULT_MIN_TLS_PROTOCOL: Protocol = Protocol::Tlsv11;
/// Set max TLS Protocol
pub const DEFAULT_MAX_TLS_PROTOCOL: Protocol = Protocol::Tlsv12;
